...
const seasons = [
  [
    CloudRain,
    "Monsoon",
    "Misty, lush, cinematic",
    "Rain-washed leaves, low clouds, and slow indoor afternoons.",
  ],
  [
    Snowflake,
    "Winter",
    "Clear air and golden mornings",
    "Crisp mornings, open views, and evenings made for firelight.",
  ],
  [
    Leaf,
    "Summer",
    "Soft shade and estate walks",
    "Cool estate trails, shaded verandahs, and longer golden hours.",
  ],
];
      ...
      <section className="relative overflow-hidden bg-[#F3F0E8] px-6 py-10 text-[#102C26] md:px-10 md:py-12 lg:px-16">
        ...
        <div className="relative mx-auto max-w-7xl">
          <div className="mb-8 grid gap-6 lg:grid-cols-[0.9fr_1.1fr] lg:items-end">
            ...
            <p
              data-scroll-reveal
              className="evaara-copy max-w-xl text-sm md:text-[15px]"
            >
              The estate never feels the same twice. Mist, sun, rain, and cool
              mountain air shift the mood of every path, meal, view, and
              evening.
            </p>
          </div>
          <div className="grid gap-5 md:grid-cols-3">
            {seasons.map(([Icon, season, text, detail], index) => (
              ...
              >
                ...
                <p className="mt-8 font-serif text-3xl text-[#102C26]">
                  {season}
                </p>
                <p className="mt-3 text-sm font-semibold text-[#536B50]">
                  {text}
                </p>
      ...
      <section className="overflow-hidden bg-[#F3F0E8] px-6 py-8 text-[#102C26] md:px-10 md:py-10 lg:px-16">
        <div className="mx-auto grid max-w-7xl items-center gap-8 lg:grid-cols-[1.04fr_0.96fr] lg:gap-12">
          ...
          >
            <img
              src={detailImage}
              alt="EVAARA dining detail in Coorg"
              loading="lazy"
          ...
          >
            ...
            <div className="mt-7 grid gap-3 sm:grid-cols-3">
              {["Estate coffee", "Local produce", "Slow dining"].map((item) => (
                <div
                  key={item}
                  className="rounded-[10px] border border-[#D9C6A5]/45 bg-[#FFFDF8]/62 px-4 py-3 text-[10px] font-bold uppercase tracking-[0.2em] text-[#536B50]"
                >
                  {item}
                </div>
              ))}
