...
function AboutStory() {
  return (
    <section className="bg-[#F3F0E8] text-[#102C26]">
      <div className="mx-auto grid max-w-7xl items-center gap-12 px-6 py-8 md:px-10 md:py-10 lg:grid-cols-[1.05fr_0.95fr] lg:px-16">
        <div data-scroll-reveal className="relative min-h-[390px] sm:min-h-[520px]">
          <img
            src={resortImage}
            alt="EVAARA resort set within Coorg coffee estate"
            loading="lazy"
            className="absolute left-0 top-0 h-[310px] w-[86%] rounded-[20px] object-cover shadow-2xl shadow-[#102C26]/15 sm:h-[430px] sm:w-[78%] sm:rounded-[24px]"
          />
          <img
            src={roomImage}
            alt="Luxury EVAARA room facing misty Coorg hills"
            loading="lazy"
            className="absolute bottom-0 right-0 h-[175px] w-[58%] rounded-[18px] border-[6px] border-[#F3F0E8] object-cover shadow-2xl shadow-[#102C26]/14 sm:h-[250px] sm:w-[48%] sm:rounded-[22px] sm:border-[8px]"
          />
        ...
        <div data-scroll-reveal>
          ...
          <div className="mt-9 grid gap-3 border-y border-[#102C26]/10 py-5 text-center sm:grid-cols-3 sm:gap-0">
      ...
      <div className="bg-[#F3F0E8] px-6 py-8 text-[#102C26] md:px-10 lg:px-16">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid border-t border-[#102C26]/10 sm:grid-cols-2 lg:grid-cols-4">
            {values.map((value) => {
              ...
              return (
                <article key={value.title} data-scroll-card className="border-b border-[#102C26]/10 py-7 sm:px-6 sm:py-8 lg:border-r lg:last:border-r-0">
