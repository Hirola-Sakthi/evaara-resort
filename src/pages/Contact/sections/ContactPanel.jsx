...
function ContactPanel() {
  return (
    <section className="relative overflow-hidden bg-[#F3F0E8] px-6 py-20 text-[#102C26] md:px-10 md:py-24 lg:px-16">
      ...
      <div data-scroll-reveal className="relative mx-auto mb-9 max-w-7xl">
        <p className="evaara-eyebrow mb-4">Contact EVAARA</p>
        <div className="grid gap-7 lg:grid-cols-[0.92fr_1.08fr] lg:items-center">
          ...
          <div className="grid gap-8 border-l border-[#B99A62]/40 pl-0 lg:pl-10">
            <p className="max-w-2xl text-base leading-8 text-[#102C26]/70">
              ...
              preferences, or questions and our team will help shape a stay that
              feels personal, calm, and beautifully curated for you.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="relative mx-auto grid max-w-7xl items-stretch gap-7 lg:grid-cols-[0.9fr_1.1fr]">
        ...
        >
            ...
            {contactItems.map((item) => {
              ...
              return (
                ...
                >
                  ...
                  <div>
                    <p className="text-[9px] font-bold uppercase tracking-[0.28em] text-[#536B50]">{item.label}</p>
                    <p className="mt-1.5 text-sm font-semibold leading-6 text-[#102C26]">{item.value}</p>
                    <p className="mt-0.5 text-xs leading-5 text-[#102C26]/52">{item.note}</p>
                  </div>
          ...
          <div className="flex flex-col gap-4 px-6 py-5 md:flex-row md:items-center md:px-7">
            <p className="text-[10px] font-bold uppercase tracking-[0.32em] text-[#102C26]">Follow Us</p>
        ...
        >
          ...
          <div className="relative flex h-full flex-col">
            <div className="grid gap-6 border-b border-[#102C26]/10 pb-6 lg:grid-cols-[1fr_0.36fr] lg:items-center">
              <div>
                <p className="evaara-eyebrow mb-3">Send Us A Message</p>
              ...
              <div className="hidden border-l border-[#102C26]/12 pl-7 text-center lg:block">
                <Leaf size={25} strokeWidth={1.5} className="mx-auto text-[#536B50]" />
            ...
            <div className="mt-6 grid flex-1 content-start gap-5">
              <div className="grid gap-5 md:grid-cols-2">
                <label className="block">
                  <span className="text-[10px] font-bold uppercase tracking-[0.24em] text-[#102C26]">Name *</span>
                  <div className="mt-2 flex h-12 items-center gap-3 rounded-[8px] border border-[#B99A62]/28 bg-[#F3F0E8]/42 px-4 transition focus-within:border-[#B99A62]">
                    <User size={18} strokeWidth={1.5} className="text-[#102C26]/62" />
                    <input
                      aria-label="Name"
                ...
                <label className="block">
                  <span className="text-[10px] font-bold uppercase tracking-[0.24em] text-[#102C26]">Email *</span>
                  <div className="mt-2 flex h-12 items-center gap-3 rounded-[8px] border border-[#B99A62]/28 bg-[#F3F0E8]/42 px-4 transition focus-within:border-[#B99A62]">
                    <Mail size={18} strokeWidth={1.5} className="text-[#102C26]/62" />
                    <input
                      aria-label="Email"
              ...
              <div className="grid gap-5 md:grid-cols-2">
                <label className="block">
                  <span className="text-[10px] font-bold uppercase tracking-[0.24em] text-[#102C26]">Phone *</span>
                  <div className="mt-2 flex h-12 items-center gap-3 rounded-[8px] border border-[#B99A62]/28 bg-[#F3F0E8]/42 px-4 transition focus-within:border-[#B99A62]">
                    <Phone size={18} strokeWidth={1.5} className="text-[#102C26]/62" />
                    <input
                      aria-label="Phone"
                ...
                <label className="block">
                  <span className="text-[10px] font-bold uppercase tracking-[0.24em] text-[#102C26]">Travel Dates</span>
                  <div className="mt-2 flex h-12 items-center gap-3 rounded-[8px] border border-[#B99A62]/28 bg-[#F3F0E8]/42 px-4 transition focus-within:border-[#B99A62]">
                    <CalendarDays size={18} strokeWidth={1.5} className="text-[#102C26]/62" />
                    <input
              ...
              <label className="block">
                <span className="text-[10px] font-bold uppercase tracking-[0.24em] text-[#102C26]">Message *</span>
                <textarea
                  aria-label="Message"
                  rows="4"
              ...
              <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
                <button className="inline-flex w-fit items-center gap-7 rounded-full bg-[#B99A62] px-7 py-3.5 text-sm font-bold text-white shadow-xl shadow-[#B99A62]/24 transition hover:bg-[#A8874E]">
                  Send Message
                ...
                <div className="flex items-center gap-3 text-sm leading-6 text-[#102C26]/54">
                  <ShieldCheck size={19} strokeWidth={1.5} className="text-[#536B50]" />
      ...
      <div data-scroll-reveal className="mx-auto mt-14 grid max-w-7xl gap-6 border-y border-[#102C26]/10 py-8 md:grid-cols-3">
        {[
      ...
      <div data-scroll-reveal className="mx-auto mt-14 max-w-7xl overflow-hidden rounded-[28px] border border-[#B99A62]/25 bg-[#FBFAF6] shadow-2xl shadow-[#102C26]/10">
        <div className="grid gap-0 lg:grid-cols-[0.72fr_1.28fr]">
          <div className="p-7 text-[#102C26] md:p-9">
            <p className="evaara-eyebrow">Find Us</p>
            <h3 className="evaara-title mt-4 text-4xl">
              In the quiet green of Coorg.
            </h3>
            <p className="evaara-copy mt-5 text-sm">
              Use the map to locate the Coorg region. Exact arrival guidance can
              be shared by our reservations team once your stay is confirmed.
            </p>
            <a
